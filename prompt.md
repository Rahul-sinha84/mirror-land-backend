I want you to go through the following hackathon and understand
...
Now I want you to focus on "Creative Storyteller ✍️" topic, that's what we are going to build

our idea summary is in SUMMARY.md file
inside which you can reference other files too

Our front end is already done, every details is on AI.md, SPEC.md and SUMMARY.md file.

so Now I'm very new to the AI thing, I want you to make this project happen, with the code and also with some settings on google ai dashboard too, for that please make a plan accordingly

This needs to be done in the perfect way, please research it well, please use context7 (https://github.com/upstash/context7) for the updated odcs, please do not refer any outdated docs, as it can delay our process please research it very well

Please feel free to ask as many questions you want, but let's avoid hallucinations (or assumptions from your side)
